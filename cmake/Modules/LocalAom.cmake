set(AVIF_LOCAL_AOM_GIT_TAG v3.8.1)
...
if(AVIF_CODEC_AVM)
    ...
    FetchContent_Declare(
        libaom URL "https://aomedia.googlesource.com/aom/+archive/${AVIF_LOCAL_AOM_GIT_TAG}.tar.gz" SOURCE_DIR
                   "${AVIF_SOURCE_DIR}/ext/aom" BINARY_DIR "${AOM_BINARY_DIR}" UPDATE_COMMAND ""
    )
endif()

...
if(EXISTS "${RAV1E_LIB_FILENAME}")
    message(STATUS "libavif: compiled rav1e library found at ${RAV1E_LIB_FILENAME}")
    ...
    message(STATUS "libavif: compiled rav1e library not found at ${RAV1E_LIB_FILENAME}; using FetchContent")
    if(EXISTS "${AVIF_SOURCE_DIR}/ext/rav1e")
        message(STATUS "libavif: ext/rav1e found; using as FetchContent SOURCE_DIR")
